...
*/
if ( ! class_exists( 'Wavo_Wp_Bootstrap_Navwalker' ) ) {
    class Wavo_Wp_Bootstrap_Navwalker extends Walker_Nav_Menu
    {
        ...
        public static function fallback($args)
        {
            if (current_user_can('edit_theme_options')) {
                echo '<li><a href="' . admin_url('nav-menus.php') . '">' . esc_html__('Add a menu', 'wavo') . '</a></li>';
            }
        }
    }
}

if ( ! class_exists( 'Wavo_Menu_Navwalker' ) ) {
    class Wavo_Menu_Navwalker extends Walker_Nav_Menu
    {
        public function start_lvl(&$output, $depth = 0, $args = array())
        {
            $indent = str_repeat("\t", $depth);
            $submenu = ($depth > 0) ? '' : '';
            $goback = wavo_settings( 'nav_goback_title' ) ? wavo_settings( 'nav_goback_title' ) : esc_html__( 'Go Back', 'wavo' );
            $output .= "\n$indent<div class=\"sub-menu depth_$depth\"><ul><li><div class=\"o-hidden\"><span class=\"sub-link back\">$goback <i class=\"fas fa-long-arrow-alt-right\"></i></span></div></li>\n";
        }
        public function end_lvl(&$output, $depth = 0, $args = array())
        {
            $output	.= "</ul></div>";
