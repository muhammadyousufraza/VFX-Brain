        ...
        private function is_minimum_version () {
            ...
            if ($this->min_redux_version != '') {
                if (version_compare($redux_ver, $this->min_redux_version) < 0) {
                    $msg = '<strong>' . esc_html__( 'The', 'wavo') . ' ' .  $this->ext_name . ' ' .  esc_html__('extension requires', 'wavo') . ' Redux Framework ' . esc_html__('version', 'wavo') . ' ' . $this->min_redux_version . ' ' .  esc_html__('or higher.','wavo' ) . '</strong>&nbsp;&nbsp;' . esc_html__( 'You are currently running', 'wavo') . ' Redux Framework ' . esc_html__('version','wavo' ) . ' ' . $redux_ver . '.<br/><br/>' . esc_html__('This field will not render in your option panel, and features of this extension will not be available until the latest version of','wavo' ) . ' Redux Framework ' . esc_html__('has been installed.','wavo' );
