...
(function(window, document, $) {
	...
	if( myLocoWrapper ) {
		...
		var myLocoWrapper = document.querySelector('.nt-locomotive-wrapper >.elementor:not(.elementor-edit-mode)');
		myLocoWrapper.setAttribute("data-scroll-container", "");
		scroll = new LocomotiveScroll({
			el: myLocoWrapper,
			smooth: true,
    ...
    $(window).on("load", function () {
        ...
        setTimeout(function() {
            ...
            var updateProgress = function () {
                var bscroll = scroll.scroll.instance.scroll.y;
                var height = $(document).height() - $(window).height();
                var progress = pathLength - (bscroll * pathLength / height);
            ...
            scroll.on('scroll', function(t) {
                ...
                $(".wavo-section-fixed-yes").parents('[data-elementor-type="header"]').addClass("wavo-section-fixed");
                if ( positionBar > 100 ) {
                    $(".wavo-section-fixed-yes").parents('[data-elementor-type="header"]').addClass("section-fixed-active");
                } else {
                    $(".wavo-section-fixed-yes").parents('[data-elementor-type="header"]').removeClass("section-fixed-active");
                }
                if (positionBar > 0) {
  ...
  imagesLoaded(myLocoWrapper, { background: true }, function () {
    scroll.update();
