...
class DynamicEmail extends \ElementorPro\Modules\Forms\Classes\Action_Base
{
    ...
    public function register_settings_section($widget)
    {
        ...
        $repeater_fields->add_control('dce_form_email_attachments', ['label' => esc_html__('Add Uploaded files as Attachments', 'dynamic-content-for-elementor'), 'type' => Controls_Manager::SWITCHER]);
